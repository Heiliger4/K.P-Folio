...
const Home = ({ homes }) => {
  console.log(`here is the data passed: ${JSON.stringify(homes, null, 2)}`);
  ...
  useEffect(() => {
    ...
    if (homes) {
      const homeDescription = homes.home_description || "I&apos;m Kidus Paulos, a passionate developer with 1.5 years of experience, crafting software solutions from Addis Ababa, Ethiopia.";
